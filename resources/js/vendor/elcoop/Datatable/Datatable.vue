			...
			<div class="table-parent">
				<div class="table-container">
					<vuetable ref="table"
							  ...
							  :per-page="perPage"
							  no-data-template="لا توجد مقالات"
						...
						<template :v-if="delete" #delete="props">
								<form method="POST" :action="`posts/delete/${props.rowData.id}`">
									<input type="hidden" name="_method" value="delete" />
									<input type="hidden" name="_token" :value="csrf">
									<div class="buttons">
										<button type="submit" class="button is-danger">حذف</button>
									</div>
								</form>
						</template>
					</vuetable>
				...
				<div class="level">
					<div class="level-left">
						<VuetablePaginationInfo class="level-item" ref="paginationInfo"
												info-template="ترقيم الصفحات"
												no-data-template="لا توجد مقالات">
						</VuetablePaginationInfo>
					</div>
					<div class="level-right">
						<VuetablePagination ref="pagination" class="level-item" prev-text="السابق"
											next-text="التالى"
